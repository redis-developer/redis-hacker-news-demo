    ...
    return (
      <div className="news-guidelines-wrapper">
        ...
        <div className="news-guidelines-text-container">
          <p className="news-guidelines-text-title">Hacker News Guidelines</p>
          ...
          <p>Please don’t use Hacker News for political or ideological battle. That destroys intellectual curiosity, which is what the site exists for.</p>
          ...
          <p>Throwaway accounts are ok for sensitive information, but please don’t create accounts routinely. Hacker News is a community—users should have an identity that others can relate to.</p>
          ...
          <p>Please don’t submit comments saying that Hacker News is turning into Reddit. It’s a semi-noob illusion, as old as the hills.</p>
